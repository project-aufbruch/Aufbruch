...
- **🔒 E2EE WebRTC Calls**: Direct peer-to-peer encrypted audio & video communication.
- **🚨 Emergency Duress Mode**: Instant decoy mode and secure local storage wipe.
- **📱 PWA & Offline Support**: Save directly to Home Screen on iOS and Android with offline-first service workers.
- **⚡ Bitcoin Lightning Zaps**: Native support for micro-tipping and creator monetization via Lightning network.
